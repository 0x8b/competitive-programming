...
assert [-1, 0, 1, 2, 3, -1, -1, -1] == [
    iterative_binary_search([1, 2, 3, 4], i) for i in range(8)
]
assert [-1, 0, 1, 2, 3, 4, -1, -1] == [
    recursive_binary_search([1, 2, 3, 4, 5], 0, 4, i) for i in range(8)
]
